...
ISP (location scope): Provider [doc_link: Vendor], Circuit Type [dropdown], Circuit ID, Static IPs, Gateway, Speed Down/Up, Account #, Support Notes (markdown)
...
Domain/DNS (company): Domain, Registrar [doc_link: Vendor], DNS Host [doc_link: Vendor], Expiration (date), Records Notes (markdown)
